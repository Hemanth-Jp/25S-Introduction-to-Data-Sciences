...
\begin{lstlisting}[language=R, caption=Factor Analysis Preparation]
...
\begin{lstlisting}[language=R, caption=KMO and Bartlett Tests]
...
\begin{lstlisting}[language=R, caption=Determining Number of Factors]
...
\begin{lstlisting}[language=R, caption=Factor Analysis Implementation]
